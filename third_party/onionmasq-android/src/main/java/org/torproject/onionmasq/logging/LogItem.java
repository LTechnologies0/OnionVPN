...
public class LogItem {
    ...
    public LogItem(long timestamp, String content, boolean verbose) {
        this.timestamp = timestamp;
        this.content = content.trim();
    ...
    public boolean equals(Object o) {
        ...
        return timestamp == logItem.timestamp && Objects.equals(content, logItem.content) && verbose == logItem.verbose;
    }

    @Override
    public int hashCode() {
        return Objects.hash(content, timestamp, verbose);
    }
}
