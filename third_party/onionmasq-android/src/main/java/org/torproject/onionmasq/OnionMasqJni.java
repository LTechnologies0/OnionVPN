...
public class OnionMasqJni {
    ...
    /**
     * Loopback SOCKS5 port for DNSCrypt / probe IsolationTokens on the same TorClient.
     * Returns 0 if the sidecar is not listening yet.
     */
    public static native long getSocksSidecarPort();
