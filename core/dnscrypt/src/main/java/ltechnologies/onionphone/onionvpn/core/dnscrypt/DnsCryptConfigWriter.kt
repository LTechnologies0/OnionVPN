...
object DnsCryptConfigWriter {
    ...
    fun write(
        ...
        val proxy = "socks5://${TunnelEndpoints.LOOPBACK}:$torSocksPort"
        val name = serverName.ifBlank { preferences.dnsCryptServerName }
        return """
            # Generated by OnionVPN — DNSCrypt upstream forced through Tor.
            ...
            # Upstream DNSCrypt server connections go through Tor SOCKS.
            proxy = '$proxy'
